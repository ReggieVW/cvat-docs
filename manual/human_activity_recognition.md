...
There is a bypass available to decouple the keyframe of the attribute activity from the keyframe of the person bounding box. This is done after creation of the bounding boxes.

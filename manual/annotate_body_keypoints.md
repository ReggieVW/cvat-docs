Remark: This task can only be executed after task [automatic annotation body keypoints](https://github.com/ReggieVW/cvat-docs/blob/main/manual/automatic_annotations.md#hrnet) is executed.
